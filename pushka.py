...
class sharik:
    def __init__(self, x=100, y=400):
        ...
        self.speed_x = 10
        self.speed_y = 10
        self.color = choice(["green", "yellow", "blue", "brown"])
...
class Pushka():
    "класс, описывающий пушку"
    def __init__(self):
        self.f2_power = 10
        self.f2_on = 0
        self.an = 1
        self.id = screen.create_line(20, 450, 50, 420, width=15)
    ...
    def targetting(self, event=0):
        ...
        if self.f2_on:
            screen.itemconfig(self.id, fill="green")
        else:
            screen.itemconfig(self.id, fill="blue")
...
def new_game():
    global g1, t1, screen1, balls, pylya
    t1.live = 1
    ...
    while t1.live or balls:
        for b in balls:
            ...
            if b.Hittest(t1) and t1.live:
                ...
                screen.itemconfig(screen1, text="цель уничтожена, кол-во выстрелов" + str(pylya))
                screen.update()
                time.sleep(3)
                new_game()
        screen.update()
